...
This extension does NOT use any third-party services, analytics, or tracking tools. The detection engine (104 rules, NLP processing) is entirely bundled within the extension and runs locally.
