...
function generatePrComment(findings, filesScanned, maxConfidence) {
  ...
  if (findings.length === 0) {
    ...
    lines.push('');
    lines.push('---');
    lines.push('*Scanned by [Forensicate.ai](https://github.com/peterhanily/forensicate.ai) · 160 detection rules*');
    return lines.join('\n');
  }
...
async function main() {
  ...
  summaryLines.push('---');
  summaryLines.push('*Scanned by [Forensicate.ai](https://github.com/peterhanily/forensicate.ai) · 160 detection rules*');
