...
export const PRICING_DATABASE: ModelPricing[] = [
  // OpenAI - https://openai.com/api/pricing/
  {
    ...
    notes: 'Advanced reasoning model with thinking tokens',
  },
  {
    provider: 'openai',
    model: 'gpt-4.1',
    ...
    notes: 'Extended 1M context window',
  },
  {
    provider: 'openai',
    model: 'gpt-4o',
  ...
  // Anthropic Claude - https://www.anthropic.com/pricing
  {
    ...
    notes: 'Most capable model (66% cheaper than Opus 4.1)',
  },
  {
    provider: 'anthropic',
  ...
  // Google Gemini - https://ai.google.dev/pricing
  {
    ...
    notes: 'Most powerful model (<200K context)',
  },
  {
    provider: 'google',
  ...
  },
  {
    ...
    notes: 'Hybrid reasoning with speed',
  },
  {
    provider: 'google',
