...
function ScannerResults({
 ...
 className="w-full flex items-center justify-between px-3 py-2 bg-gray-800/50 border-b border-gray-700 hover:bg-gray-800/30 dark:hover:bg-gray-800/30 light:hover:bg-gray-100 transition-colors"
 >
 {headerContent}
 </button>
 ) : (
