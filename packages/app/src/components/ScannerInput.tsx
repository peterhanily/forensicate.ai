...
export default function ScannerInput({
 ...
 <span className="text-gray-400 text-gray-400 text-xs font-mono">prompt_input</span>
 </div>
 <div className="flex items-center gap-2">
 {onSavePrompt && promptText.trim() && (
 <button
 onClick={onSavePrompt}
 className="text-gray-500 text-gray-500 hover:text-[#c9a227] text-xs font-mono transition-colors"
 ...
 <button
 onClick={onClear}
 className="text-gray-500 text-gray-500 hover:text-gray-300 dark:hover:text-gray-300 light:hover:text-gray-900 text-xs font-mono transition-colors"
 >
 clear
 </button>
 </div>
