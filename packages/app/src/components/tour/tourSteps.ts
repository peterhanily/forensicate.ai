...
export const tourSteps: TourStep[] = [
  {
    ...
    description: 'This scanner helps you detect prompt injection attacks using 168 detection rules. Everything runs in your browser - no API keys or server required.',
    placement: 'bottom',
    beforeShow: () => {
