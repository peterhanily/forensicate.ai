...
function DesktopNav({ onDownload }: { onDownload: () => void }) {
 return (
   <nav className="hidden lg:flex items-center" aria-label="Main navigation">
     ...
     <div className="ml-1 flex items-center border-l border-gray-700 pl-2 gap-0.5">
       {/* Download standalone */}
       <button
         onClick={onDownload}
       ...
       >
         <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
           <path d="M12 0C8.21 0 4.831 1.757 2.632 4.501l3.953 6.848A5.454 5.454 0 0 1 12 6.545h10.691A12 12 0 0 0 12 0zM1.931 5.47A11.943 11.943 0 0 0 0 12c0 6.012 4.42 10.991 10.189 11.864l3.953-6.847a5.45 5.45 0 0 1-6.865-2.29zm13.342 2.166a5.446 5.446 0 0 1 1.45 7.09l.002.001-3.953 6.848c.31.023.622.035.937.035 6.627 0 12-5.373 12-12 0-1.006-.127-1.983-.361-2.918H15.47zM12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7z"/>
         </svg>
       </a>
       ...
       >
         <svg className="w-[18px] h-[18px]" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
...
export default function Layout() {
 ...
 rel="noopener noreferrer"
 onClick={closeMobileMenu}
 className="w-full mt-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold rounded-lg flex items-center justify-center gap-2 hover:from-blue-700 hover:to-blue-800 transition-colors"
 >
 ...
 <span className="px-1.5 py-0.5 bg-white/20 rounded text-xs">Install</span>
 </a>
 </nav>
 )}
 </div>
