        ...
        <div className="max-w-6xl mx-auto px-4 py-3 md:py-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-2">
              ...
              <div className="ml-3 px-3 py-1.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-xs font-semibold rounded-lg shadow-lg flex items-center gap-1.5 animate-pulse">
          ...
          {mobileMenuOpen && (
            <nav className="md:hidden mt-3 pt-3 border-t border-gray-800 space-y-1">
              ...
              <div className="w-full mt-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold rounded-lg flex items-center justify-center gap-2 animate-pulse">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-.84 4.67h1.68v8.36h3.36L12 18.155 7.8 13.03h3.36V4.67z"/>
                </svg>
                <span>Chrome Extension</span>
