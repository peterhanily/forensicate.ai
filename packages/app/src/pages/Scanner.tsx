...
export default function Scanner() {
 ...
 <p className="text-gray-400 text-gray-400 text-xs sm:text-sm">
 ...
 : 'bg-gray-800 bg-gray-800 border-gray-700 border-gray-700 text-gray-400 text-gray-400'
 }`}
 >
 ...
 {showConfidenceInfo && (
 <div className="px-3 py-2 border-t border-gray-800/50 border-gray-800/50 bg-gray-800/30 bg-gray-800/30">
 <div className="text-[10px] text-gray-400 text-gray-400 space-y-1">
 <div className="text-gray-300 text-gray-300 font-medium">Confidence Scoring Formula</div>
 ...
 {showAnnotations && (
 <div className="px-3 py-2 border-t border-gray-800 border-gray-800">
 <AnnotatedPrompt
 text={promptText}
 scanResult={scanResult}
 onRuleClick={handleRuleClick}
 ...
 className="flex-1 px-3 py-2 bg-gray-800 bg-gray-800 hover:bg-gray-700 dark:hover:bg-gray-700 light:hover:bg-gray-200 text-gray-300 text-gray-300 rounded-lg transition-colors flex items-center justify-center gap-2 border border-gray-700 border-gray-700"
 >
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
