...
const FEATURES = [
  {
    ...
    desc: '149 detection rules across keyword, regex, heuristic, NLP, and file-based analysis. Real-time confidence scoring with OWASP and MITRE ATLAS compliance mapping.',
    link: '/scanner',
    icon: (
    ...
    <div className="space-y-16 pb-12">
      ...
      <section className="text-center pt-8 md:pt-16">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#c9a227]/10 border border-[#c9a227]/30 text-[#c9a227] text-xs mb-6">
          ...
          149 detection rules across 20 categories
        </div>
