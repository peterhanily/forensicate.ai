  ...
  return (
    <article className="max-w-3xl mx-auto pb-16 space-y-8">
      ...
      <section id="approaches">
        ...
        <p className="text-xs text-gray-500 mt-2">Forensicate.ai uses the first three approaches (168 rules: 49 keyword, 91 regex, 11 heuristic, 4 NLP, 13 file-based) to provide fast, offline-capable detection with zero external dependencies.</p>
      </section>
...
$ echo "test" | forensicate -j`}
      ...
      <div className="border border-[#c9a227]/30 rounded-lg bg-[#c9a227]/5 p-6 text-center">
        ...
        <p className="text-xs text-gray-400 mb-4">168 detection rules. Zero dependencies. Works offline.</p>
