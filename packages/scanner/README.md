...
The 104 built-in rules cover five detection strategies:

| Type | Count | Description |
|---|---|---|
| **Keyword** | 32 | Case-insensitive phrase matching for known attack patterns like "ignore previous instructions" |
| **Regex** | 51 | Pattern matching for structural attacks, encoding tricks, and obfuscated payloads |
| **Heuristic** | 4 | Programmatic analysis detecting statistical anomalies like unusual character distributions and entropy |
