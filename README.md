...
### Detection Rules (176 Rules in 20 Categories)

- **Keyword Detection (49 rules)**: Pattern matching for known injection phrases
...
- **Regex Pattern Detection (97 rules)**: Advanced pattern matching
